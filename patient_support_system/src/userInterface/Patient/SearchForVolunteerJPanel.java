...
public class SearchForVolunteerJPanel extends javax.swing.JPanel implements JMapViewerEventListener{
    ...
    private void initComponents() {
        ...
        volview = new javax.swing.JButton();
        reqeustbtn = new javax.swing.JButton();
        ...
        volview.setText("View Volnteer in detail");
        volview.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                volviewActionPerformed(evt);
            }
        });

        reqeustbtn.setText("Request Volunteer For Support");
        reqeustbtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                reqeustbtnActionPerformed(evt);
            }
        });
        ...
        jInternalFrame1Layout.setVerticalGroup(
            ...
            .addGroup(jInternalFrame1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jMapViewerVolunteer, javax.swing.GroupLayout.DEFAULT_SIZE, 551, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(boxnetwork, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(manageEnt1, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(46, 46, 46)
                        .addComponent(reqeustbtn)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(volview))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(14, 14, 14)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(manageEnt2, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(27, 27, 27)
    ...
    private void boxnetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxnetworkActionPerformed
       if(boxnetwork.getSelectedIndex()>=0)
       {
    ...
    private void volviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_volviewActionPerformed
    ...
    }//GEN-LAST:event_volviewActionPerformed

    private void reqeustbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reqeustbtnActionPerformed
    ...
    }//GEN-LAST:event_reqeustbtnActionPerformed
    ...
    private javax.swing.JButton reqeustbtn;
    private javax.swing.JTable volunteerListTable;
    private javax.swing.JButton volview;
