...
public class VolunteerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        manageEnt.setText("Volunteer Main Page ");

        viewPersonalHelpRequestBtn.setText(" click to View Personal Suppport  Requests");
        ...
        manageVolunteerProfileBtn.setText("click to Update Profile ");
        ...
        viewTestimonialsBtn.setText("click to View feedback");
        ...
        manageEnt1.setText("Welcome to Patient Support System ");

        viewAnonymousReqBtn.setText("Click to View Anonymous Support  Requests");
        ...
        viewVolProfileBtn.setText("click to View Profile");
