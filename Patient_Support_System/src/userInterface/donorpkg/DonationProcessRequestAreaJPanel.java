...
public class DonationProcessRequestAreaJPanel extends javax.swing.JPanel {
   ...
   private  UserAccount userAccount;
    ...
    public DonationProcessRequestAreaJPanel(JPanel userProcessContainer, NeedSensorDeviceWorkRequest needSensorDeviceWorkRequest, UserAccount userAccount) {
        ...
        box_2.addItem(SupervisorWorkRequest.REQUEST_ACCEPT);
        box_2.addItem(SupervisorWorkRequest.REQUEST_REJECT);
    }
    ...
    private void addInputVerifiers() {
        ...
        comment_2.setInputVerifier(stringValidation);
    }
    ...
    private void initComponents() {
        ...
        comment_2 = new javax.swing.JTextField();
        psubmit_2 = new javax.swing.JButton();
        ...
        psubmit_2.setText("Submit ");
        psubmit_2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                psubmit_2ActionPerformed(evt);
            }
        });
        ...
        jLabel7.setText("Action on Donation:");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(comment_2)
                                    .addComponent(box_2, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 406, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(228, 228, 228)
                        .addComponent(back_2)
                        .addGap(32, 32, 32)
                        .addComponent(psubmit_2)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(box_2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(comment_2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(89, 89, 89)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(psubmit_2)
                    .addComponent(back_2))
    ...
    private void psubmit_2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_psubmit_2ActionPerformed
        if(box_2.getSelectedIndex()<0 || comment_2.getText().trim().isEmpty())
        {
            JOptionPane.showMessageDialog(null, "Please enter data in all fields", "warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        needSensorDeviceWorkRequest.setdonationRequestResult((String)box_2.getSelectedItem());
        needSensorDeviceWorkRequest.setComments(comment_2.getText());
        ...
        comment_2.setText("");
    }//GEN-LAST:event_psubmit_2ActionPerformed
    ...
    private javax.swing.JTextField comment_2;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JLabel jLabel7;
    private javax.swing.JButton psubmit_2;
